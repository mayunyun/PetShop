...
//                [dic setObject:[array[0] objectForKey:@"jxaccountid"] forKey:@"salerid"];
...
//                [dic setObject:[array[0] objectForKey:@"accountname"] forKey:@"saler"];
...
//
//            [HTNetWorking postWithUrl:[NSString stringWithFormat:@"%@myorder?action=addOrder",PAY_INTERFACE] refreshCache:YES params:params success:^(id response) {
//                NSString* str = [[NSString alloc]initWithData:response encoding:NSUTF8StringEncoding];
