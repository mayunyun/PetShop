 ...
 */
    ...
    NSDictionary* params = @{@"data":[NSString stringWithFormat:@"{\"person_name\":\"%@\",\"person_tel\":\"%@\",\"id\":\"%@\",\"provinceid\":\"%@\",\"cityid\":\"%@\",\"areaid\":\"%@\",\"person_address\":\"%@\",\"defaultVal\":\"%@\"}",tfName.text,tfPhone.text,self.addrModel.Id,_provinceid,_cityid,_countryid,textField.text,defaultStr]};
    //NSLog(@"%@",params);
 ...
 */
    ...
    NSDictionary* params = @{@"data":[NSString stringWithFormat:@"{\"person_name\":\"%@\",\"person_tel\":\"%@\",\"provinceid\":\"%@\",\"cityid\":\"%@\",\"areaid\":\"%@\",\"person_address\":\"%@\",\"defaultVal\":\"%@\"}",tfName.text,tfPhone.text,_provinceid,_cityid,_countryid,textField.text,defaultStr]};
