...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JVShopcartBrandModel *brandModel;
    if (self.dataArray.count) {
        brandModel = self.dataArray[indexPath.row];
    }
    JVShopcartCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JVShopcartCell"];
    if (self.dataArray.count > indexPath.row) {
        [cell configureShopcartCellWithProductURL:brandModel.autoname productName:brandModel.proname productPrice:brandModel.price productCount:brandModel.count productStock:brandModel.specification productSelected:brandModel.isSelected secondtoremainder:brandModel.sectoremain maintosecond:brandModel.maintosec mainunitname:brandModel.mainunitname JVShopcartBrandModel:brandModel];
    }
