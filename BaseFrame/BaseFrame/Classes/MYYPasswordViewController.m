...
//    UIImageView *titleimage0 = [[UIImageView alloc]initWithFrame:CGRectMake(20, 20*MYWIDTH, 15, 18)];
//    titleimage0.image = [UIImage imageNamed:@"手机"];
//    [bgview addSubview:titleimage0];
    
//    self.textField0 = [[UITextField alloc]initWithFrame:CGRectMake(50, 0, bgview.width - 70, 59*MYWIDTH)];
//    self.textField0.delegate = self;
//    self.textField0.layer.cornerRadius = 5;
////    self.textField0.keyboardType = UIKeyboardTypeNumberPad;
//    self.textField0.clearButtonMode = UITextFieldViewModeWhileEditing;
//    self.textField0.layer.borderColor = [UIColor grayColor].CGColor;
//    self.textField0.placeholder = @"请输入用户名";
//    [self.textField0 setValue:[UIFont boldSystemFontOfSize:14] forKeyPath:@"_placeholderLabel.font"];
//    [bgview addSubview:self.textField0];
//    UILabel *xian0 = [[UILabel alloc]initWithFrame:CGRectMake(20, CGRectGetMaxY(self.textField0.frame)+1, bgview.width - 40, 1)];
//    xian0.backgroundColor = UIColorFromRGB(0xefefef);
//    [bgview addSubview:xian0];
...
- (void)nestBtnAction:(UIButton *)sender{
    ...
    if ([self.textField0.text isEqualToString:@""]) {
        [self showAlert:@"请填写用户名"];
        return;
    }
