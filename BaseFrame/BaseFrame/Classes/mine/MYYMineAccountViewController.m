...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray* titleArray =@[@"我的头像",@"账户",@"姓名",@"手机号",@"余额",@"密码",@"单位公司全称",@"统一社会信用代码",@"单位地址",@"单位电话",@"开户银行",@"银行账号"];
...
//        NSString* baseurl = HTURL;
        [_headerBtn sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@/%@",PAY_INTERFACE,_usermodel.folder,_usermodel.autoname]] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"默认头像"]];
        ...
        if (indexPath.row == 1) {
            if ([Command isBlankString:_usermodel.name]) {
...
//            label.text = [NSString stringWithFormat:@"%@",_usermodel.accountname];
            ...
            if ([Command isBlankString:[NSString stringWithFormat:@"%@",_usermodel.balance]]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
                label.text = [NSString stringWithFormat:@"%@",_usermodel.balance];
            }
//            label.text = [NSString stringWithFormat:@"%@",_usermodel.score];
        ...
        if (indexPath.row == 2) {
            ...
            if ([Command isBlankString:_usermodel.receivercell]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
                label.text = [NSString stringWithFormat:@"%@",_usermodel.receivercell];
            }
        }else if (indexPath.row == 5){
            label.text = @"修改密码";
        }else if (indexPath.row == 6){
            if ([Command isBlankString:_usermodel.companyname]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
                label.text = [NSString stringWithFormat:@"%@",_usermodel.companyname];
            }
        }else if (indexPath.row == 7){
            if ([Command isBlankString:_usermodel.honesty]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
                label.text = [NSString stringWithFormat:@"%@",_usermodel.honesty];
            }
        }else if (indexPath.row == 8){
            if ([Command isBlankString:_usermodel.companyaddress]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
            ...
            if ([Command isBlankString:_usermodel.companyphone]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
                label.text = [NSString stringWithFormat:@"%@",_usermodel.companyphone];
            }
        }else if (indexPath.row == 10){
            if ([Command isBlankString:_usermodel.companybank]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
                label.text = [NSString stringWithFormat:@"%@",_usermodel.companybank];
            }
        }else if (indexPath.row == 11){
            if ([Command isBlankString:_usermodel.companyaccount]) {
                label.text = [NSString stringWithFormat:@"%@",@""];
            }else{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!IsEmptyValue(_usermodel.receivercell)) {
...
//    NSString* baseUrl = HTURL;
    NSString* urlStr = [NSString stringWithFormat:@"%@%@",PAY_INTERFACE,@"personal?action=uploadCustomerImage"];
