...
//        NSString * pric = [NSString stringWithFormat:@"%.2f",[itemsModel.minsaleprice floatValue]/[itemsModel.sectoremain floatValue]];
        NSString * pric = [Command formatFloat:[itemsModel.minsaleprice floatValue]/[itemsModel.sectoremain floatValue]];
...
//        cell.numerLab.text = [NSString stringWithFormat:@"￥%@/%@     库存:%@",pric,itemsModel.remainderunitname,@"0"];
        [cell setstockcount:itemsModel.id price:pric secondunitname:itemsModel.remainderunitname maintosecond:itemsModel.maintosec];
        NSLog(@"这个地方对不对%@",itemsModel.maintosec);
