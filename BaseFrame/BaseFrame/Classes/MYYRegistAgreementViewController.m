...
- (void)creatUI{
    ...
    NSLog(@"%@",[NSString stringWithFormat:@"%@%@",baseurl,@"aichongMatter/weixinpage/register/deal.html"]);
    [_webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@aichongMatter/weixinpage/register/deal.html",baseurl]]]];
