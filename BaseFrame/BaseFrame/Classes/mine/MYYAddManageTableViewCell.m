...
- (void)layoutSubviews{
    ...
    self.addressLabel.text = [NSString stringWithFormat:@"%@%@%@%@",self.model.province,self.model.city,self.model.area,self.model.address];
    NSLog(@"%@-%@-%@-%@",self.model.province,self.model.city,self.model.area,self.model.address);
