...
- (void)layoutSubviews{
    ...
    NSString * price = [Command formatFloat:[_model.saleprice floatValue]/[_model.maintosec floatValue]/[_model.sectoremain floatValue]];
    self.priceLabel.text = [NSString stringWithFormat:@"￥ %@/%@",price,_model.remainderunitname];
