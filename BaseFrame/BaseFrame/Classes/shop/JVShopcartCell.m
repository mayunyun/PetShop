...
- (void)configureShopcartCellWithProductURL:(NSString *)productURL productName:(NSString *)productName productPrice:(float)productPrice productCount:(NSInteger)productCount productStock:(float)productStock productSelected:(BOOL)productSelected secondtoremainder:(NSString *)secondtoremainder
                               maintosecond:(NSString *)maintosecond mainunitname:(NSString *)mainunitname JVShopcartBrandModel:(JVShopcartBrandModel*)model{
    ...
    if ([user isEqualToString:@"1"]) {
        self.productPriceLable.text = [NSString stringWithFormat:@"￥%.2f/%@", productPrice/[maintosecond floatValue],model.secondunitname];
    }else if ([user isEqualToString:@"2"]){
        self.productPriceLable.text = [NSString stringWithFormat:@"￥%.2f/%@", productPrice/[maintosecond floatValue]/[secondtoremainder floatValue],model.remainderunitname];
    }else{
